		...
		<div class="post-meta">
			...
			<?php if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) : ?>
				...
				<i class="fa fa-comments-o"></i>
					<?php comments_popup_link( esc_html__( 'Оставить комментарий', 'asterion' ), esc_html__( '1 комментарий', 'asterion' ), esc_html__( '% комментариев', 'asterion' ) ); ?>
				</span>
			<?php endif; ?>
		<?php 
			//load categories
		...
		<?php if( ! is_single() ) : ?>
			<div class="read-more">
				<a href="<?php the_permalink(); ?>" class="btn">
					<?php esc_html_e( 'Продолжить чтение', 'asterion' ); ?>
				</a>
			</div>
		<?php endif; ?>
