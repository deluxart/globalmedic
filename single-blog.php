...
//				'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'Ember' ) . '</span> ' .
//					'<span class="screen-reader-text">' . __( 'Next post:', 'Ember' ) . '</span> ' .
//					'<span class="post-title">%title</span>',
//				'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'Ember' ) . '</span> ' .
//					'<span class="screen-reader-text">' . __( 'Previous post:', 'Ember' ) . '</span> ' .
//					'<span class="post-title">%title</span>',
//			) );
    ...
    <nav id="sidebar" class="course">
      <h2 class="widget-title">Последние статьи</h2>
       <ul>
 <?php
 $pc = new WP_Query('cat=1&orderby=date&posts_per_page=3'); ?>
